...
*/
    ...
    function initSliders() {
        if (document.querySelector(".projects-swiper")) new swiper_core_Swiper(".projects-swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.6,
        ...
        if (document.querySelector(".profit-swiper")) new swiper_core_Swiper(".profit-swiper", {
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            speed: 800,
